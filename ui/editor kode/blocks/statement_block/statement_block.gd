...
const ParameterInput = preload("res://ui/editor kode/blocks/utilities/parameter_input/parameter_input.gd")
const ParameterInputScene = preload("res://ui/editor kode/blocks/utilities/parameter_input/parameter_input.tscn")
...
static func get_scene_path():
	return "res://ui/editor kode/blocks/statement_block/statement_block.tscn"
...
static func format_string(parent_block: Block, attach_to: Node, string: String, _defaults: Dictionary) -> Array:
	...
	for result in results:
		...
		if child_label_text != "":
			...
			label_node.text = child_label_text
