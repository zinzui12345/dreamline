...
const Background = preload("res://ui/editor kode/blocks/utilities/background/background.gd")
const Constants = preload("res://skrip/editor kode/constants.gd")
const DragDropArea = preload("res://ui/editor kode/blocks/utilities/drag_drop_area/drag_drop_area.gd")
const Gutter = preload("res://ui/editor kode/blocks/utilities/background/gutter.gd")
...
static func get_scene_path():
	return "res://ui/editor kode/blocks/control_block/control_block.tscn"
...
func format():
	...
	for i in block_formats.size():
		...
		var snap_point: SnapPoint = preload("res://ui/editor kode/blocks/utilities/snap_point/snap_point.tscn").instantiate()
