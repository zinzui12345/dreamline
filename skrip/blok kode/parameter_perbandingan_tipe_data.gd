...
func hasilkan_kode() -> String:
	...
	if left_block != null and left_block is BlokParameter:
		...
		result += $MarginContainer/compare_operator/left_value/left_default_value.text
	...
	if right_block != null and right_block is BlokParameter:
		...
		result += $MarginContainer/compare_operator/right_value/right_default_value.text
	result += ")"
	return result
