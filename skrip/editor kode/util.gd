...
const SCENE_PER_TYPE = {
	Types.BlockType.ENTRY: preload("res://ui/editor kode/blocks/entry_block/entry_block.tscn"),
	Types.BlockType.STATEMENT: preload("res://ui/editor kode/blocks/statement_block/statement_block.tscn"),
	Types.BlockType.VALUE: preload("res://ui/editor kode/blocks/parameter_block/parameter_block.tscn"),
	Types.BlockType.CONTROL: preload("res://ui/editor kode/blocks/control_block/control_block.tscn"),
}
...
static func get_variable_block_definitions(variables: Array[VariableResource]) -> Array[BlockDefinition]:
	...
	for variable: VariableResource in variables:
		...
		b.display_template = "ketika_mengatur_variabel %s" % variable.var_name # str(TranslationServer.translate("%ketika_mengatur_properti")) % [property.name.capitalize(), type_string],
...
static func instantiate_variable_blocks(variables: Array[VariableResource]) -> Array[Block]:
	...
	for block_definition in get_variable_block_definitions(variables):
		...
		b.color = Constants.BUILTIN_CATEGORIES_PROPS["%variabel%"].color
		blocks.append(b)
