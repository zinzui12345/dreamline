...
const BlockCategoryDisplay = preload("res://skrip/editor kode/picker/categories/block_category_display.gd")
const CategoryFactory = preload("res://skrip/editor kode/picker/categories/category_factory.gd")
const VariableCategoryDisplay = preload("res://skrip/editor kode/picker/categories/variable_category/variable_category_display.gd")
...
func init_picker(extra_blocks: Array[Block] = [], extra_categories: Array[BlockCategory] = []):
	...
	for _category in block_categories:
		...
		if category.name != "%variabel%":
			block_category_display = preload("res://ui/editor kode/picker/categories/block_category_display.tscn").instantiate()
		else:
			block_category_display = preload("res://ui/editor kode/picker/categories/variable_category/variable_category_display.tscn").instantiate()
