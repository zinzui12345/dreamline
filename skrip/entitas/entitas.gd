...
func _sinkronkan_perubahan_kondisi() -> void:
...
# bisa juga menggunakan _process(delta) tetapi kondisi harus di sinkronkan dengan memanggil _sinkronkan_perubahan_kondisi()
...
func _process(delta : float) -> void:
	...
	if id_proses == client.id_koneksi: _sinkronkan_perubahan_kondisi()
