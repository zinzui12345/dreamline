...
func _enter_tree():
	...
	#add_custom_type("server", "Node", load("res://skrip/server.gd"), load("res://addons/LANServerBroadcast/server_advertiser/server_advertiser.png"))
	#add_custom_type("client", "Node", load("res://skrip/client.gd"), load("res://addons/LANServerBroadcast/server_listener/server_listener.png"))
